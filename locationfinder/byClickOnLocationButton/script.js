...
locationButton.addEventListener("click", () =>{
    //Geolocation API is used to get geographical position of a user 
...
const showLocation = async (position) => {
    //we user the Nominatim API for getting actual addres from logitude and longitude
